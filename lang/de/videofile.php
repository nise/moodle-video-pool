...
$string['modulename'] = 'Videodatei';
$string['modulenameplural'] = 'Videodateien';
...
$string['videofile:addinstance'] = 'Neue Videodatei hinzufügen';
$string['videofile:view'] = 'Videodatei ansehen';

$string['pluginadministration'] = 'Videodatei verwalten';
$string['pluginname'] = 'Videodatei';

$string['videofile_defaults_heading'] = 'Standardwerte der Videodatei-Einstellungen';
...
$string['filearea_posters'] = 'Vorschaubild';
$string['filearea_videos'] = 'Videos';

$string['video_fieldset'] = 'Videodatei';
...
$string['limitdimensions'] = 'Solle die Größe im Responsive-Modus beschränkt sein?';
...
$string['err_positive'] = 'Sie müssen eine positive Zahl eingeben';

$string['video_not_playing'] = 'Video not playing? Try {$a}.';

$string['creator'] = 'Urheber';
$string['subject'] = 'Betreff';
$string['publisher'] = 'Herausgeber';
$string['contributor'] = 'Mit wirkende';
$string['date'] = 'Datum der Erstellung';
$string['source'] = 'Quelle';
$string['language'] = 'Sprache';
$string['relation'] = 'Realtion';
$string['coverage'] = 'Coverage';
$string['rights'] = 'Urheberrechte';
$string['license'] = 'Lizenz';
$string['institution'] = 'Institution';
$string['videotags'] = 'Schlagworte';
$string['sports'] = 'Sportart';
$string['compentencies'] = 'Kompetenzen';
$string['courselevel'] = 'Klassenstufe';
$string['movements'] = 'Bewegungen';
$string['activities'] = 'Aktivitäten';
$string['actors'] = 'Akteure';
$string['perspectives'] = 'Perspektiven';
$string['location'] = 'Ort';


$string['fieldsetdc'] = 'Metadaten der Videoressource';
$string['fieldsetdidactic'] = 'Didaktische Metadaten';
